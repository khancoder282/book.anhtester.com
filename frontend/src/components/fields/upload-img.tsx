...
export function UploadImg({ sx }: { sx?: Sx }) {
  const theme = useTheme();
  return (
    <SvgIcon sx={sx} aria-hidden="true" viewBox="0 0 480 360" xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      />
      <path
        stroke={theme.vars.palette.primary.darker}
        strokeLinecap="round"
        strokeWidth="0.5"
